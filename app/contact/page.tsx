    ...
    <div className="min-h-screen bg-gradient-to-b from-amber-50 via-rose-50 to-amber-50">
      ...
      <section className="pt-28 pb-16 px-6">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-slate-600 leading-relaxed">
            I'd love to hear from you. Whether you have questions about my art,
            want to commission a piece, or simply wish to share your thoughts,
            every message is a blessing.
          </p>
        </div>
      </section>
              ...
              <div className="space-y-6">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-slate-600">abc@gmail.com</p>
                  </div>
                </div>
                <div className="flex items-center gap-4">
                  <div className="w-12 h-12 bg-gradient-to-r from-amber-200 to-rose-200 rounded-full flex items-center justify-center">
                  ...
                  <div>
                    ...
                    <p className="text-slate-600">03XXXXXXXXX</p>
                  </div>
                </div>
                <div className="flex items-center gap-4">
                  <div className="w-12 h-12 bg-gradient-to-r from-amber-200 to-rose-200 rounded-full flex items-center justify-center">
      ...
      <section className="py-20 px-6 bg-gradient-to-r from-rose-50 to-amber-50">
        <div className="max-w-4xl mx-auto">
          <h2 className="font-serif text-3xl text-amber-900 text-center mb-12">
            Frequently Asked Questions
          </h2>
          <div className="space-y-6">
            <Card className="p-6 border-0 shadow-lg bg-white/80 backdrop-blur-sm">
              <h3 className="font-serif text-xl text-amber-900 mb-3">
                Do you only work with Quranic verses?
              </h3>
              <p className="text-slate-600">
                I specialize in Quranic verses, the 99 names of Allah (Asma
                ul-Husna), Islamic duas, and other Islamic content. I work
                closely with Islamic scholars to ensure accuracy and proper
                respect for the sacred texts.
              </p>
            </Card>
            <Card className="p-6 border-0 shadow-lg bg-white/80 backdrop-blur-sm">
              <h3 className="font-serif text-xl text-amber-900 mb-3">
                What Arabic scripts do you use?
              </h3>
              <p className="text-slate-600">
                I work with traditional Arabic calligraphy scripts including
                Thuluth, Naskh, Diwani, Kufic, and Nastaliq. Each script has its
                own beauty and is chosen based on the content and the spiritual
                feeling we want to convey.
              </p>
            </Card>
            <Card className="p-6 border-0 shadow-lg bg-white/80 backdrop-blur-sm">
              <h3 className="font-serif text-xl text-amber-900 mb-3">
                Are your artworks suitable for Islamic homes?
              </h3>
              <p className="text-slate-600">
                Absolutely. All my artwork follows Islamic principles and
                guidelines. I focus on Quranic verses, Allah's names, and
                Islamic themes that bring barakah and spiritual beauty to Muslim
                homes and spaces.
              </p>
            </Card>
            <Card className="p-6 border-0 shadow-lg bg-white/80 backdrop-blur-sm">
              ...
              <p className="text-slate-600">
                Yes, each piece comes with accurate English translations and
                transliterations. I also provide context about the verse or
                Islamic concept depicted, helping to deepen understanding and
                appreciation.
              </p>
            </Card>
          </div>
