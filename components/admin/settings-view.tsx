...
export default function SettingsView() {
  const [settings, setSettings] = useState({
    ...
    siteDescription:
      "Where art becomes prayer - Sacred Islamic calligraphy and paintings",
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          ...
          <p className="text-slate-600">
            Configure your gallery settings and preferences
          </p>
        </div>
        <Button
          onClick={handleSave}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-1">
          <Card className="p-4 border-0 shadow-lg bg-white/90 backdrop-blur-sm">
            <h3 className="font-serif text-lg text-amber-900 mb-4">
              Settings Categories
            </h3>
            <div className="space-y-2">
              <Button
                variant="ghost"
                className="w-full justify-start text-amber-900 bg-amber-50"
              >
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center justify-between">
                ...
                <Switch
                  ...
                  onCheckedChange={(checked) =>
                    handleSettingChange("customerNotifications", checked)
                  }
                />
              </div>
              <Separator />
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                ...
                <Switch
                  ...
                  onCheckedChange={(checked) =>
                    handleSettingChange("enableCOD", checked)
                  }
                />
              </div>
              {settings.enableCOD && (
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      handleSettingChange("codFee", Number(e.target.value))
                    }
              ...
              <div className="flex items-center justify-between">
                ...
                <Switch
                  ...
                  onCheckedChange={(checked) =>
                    handleSettingChange("enablePayPal", checked)
                  }
                />
              </div>
              <Separator />
              <div className="flex items-center justify-between">
                ...
                <Switch
                  ...
                  onCheckedChange={(checked) =>
                    handleSettingChange("enableStripe", checked)
                  }
                />
              </div>
            </div>
          ...
          <Card className="p-6 border-0 shadow-lg bg-white/90 backdrop-blur-sm">
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                <div>
                  <Label
                    htmlFor="enableIslamicGreeting"
                    className="text-amber-900 font-medium"
                  >
                    Islamic Greetings
                  </Label>
                  <p className="text-sm text-slate-600">
                    Show "Assalamu Alaikum" and Islamic phrases
                  </p>
                </div>
                <Switch
                  ...
                  onCheckedChange={(checked) =>
                    handleSettingChange("enableIslamicGreeting", checked)
                  }
                />
              </div>
              <Separator />
              <div className="flex items-center justify-between">
                ...
                <Switch
                  ...
                  onCheckedChange={(checked) =>
                    handleSettingChange("enableIslamicCalendar", checked)
                  }
                />
              </div>
              <Separator />
              <div className="flex items-center justify-between">
                <div>
                  <Label
                    htmlFor="enablePrayerTimes"
                    className="text-amber-900 font-medium"
                  >
                    Prayer Times
                  </Label>
                  <p className="text-sm text-slate-600">
                    Show daily prayer times widget
                  </p>
                </div>
                <Switch
                  ...
                  onCheckedChange={(checked) =>
                    handleSettingChange("enablePrayerTimes", checked)
                  }
                />
              </div>
            </div>
